...
export default function Slideshow(props) {
    ...
    const rtlDirectionModifier = isHorizontal && writingDirection === "rtl" ? -1 : 1; /* For pausing on hover */
    ...
    const measure = useCallback(() => {
        if (!parentRef.current) return; // Might be RTL but executing before writingDirection is set so derive from positions of elements
            ...
            children: [ /*#__PURE__*/ _jsxs(motion.div, {
                ...
                children: [ /*#__PURE__*/ _jsx(motion.button, {
                    ...
                    children: /*#__PURE__*/ _jsx("img", {
                        ...
                        width: arrowSize,
                        height: arrowSize,
                        src: isHorizontal && writingDirection === "rtl" ? rightArrowSrc : leftArrowSrc,
                        alt: "Back Arrow"
                    })
                    ...
                    children: /*#__PURE__*/ _jsx("img", {
                        ...
                        width: arrowSize,
                        height: arrowSize,
                        src: isHorizontal && writingDirection === "rtl" ? leftArrowSrc : rightArrowSrc,
                        alt: "Next Arrow"
                    })
                })]
...
const Slide = /*#__PURE__*/ memo( /*#__PURE__*/ forwardRef(function Component(props, ref) {
    const {
        ...
        isLast,
        index,
        /** 1 or -1 depending on if horizontal and rtl writing direction */ directionModifier
    } = props;
...
function useWritingDirection() {
    const [writingDirection, setWritingDirection] = useState("ltr"); // must be done this way to ensure that there isn't a mismatch with SSG
